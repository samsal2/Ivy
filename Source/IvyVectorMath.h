...
IVY_API void ivyCrossV2ToV2(IvyV2 const lhs, IvyV2 const rhs, IvyV2 const out);
IVY_API void ivyCrossV3ToV3(IvyV3 const lhs, IvyV3 const rhs, IvyV3 out);
IVY_API void ivyCrossV4ToV4(IvyV4 const lhs, IvyV4 const rhs, IvyV4 const out);
...
IVY_API void ivyCreateLookAtM4(IvyV3 const eye, IvyV3 const at, IvyV3 const up,
    IvyM4 out);
